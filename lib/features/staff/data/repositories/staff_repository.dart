...
/// Repositori untuk komunikasi langsung dengan API fitur Staf.
/// Bertanggung jawab atas fetching data mentah dan pengiriman request HTTP.
class StaffRepository {
  ...
  Future<Response> updateMedicine(String id, dynamic data) {
    if (data is FormData) {
      // Laravel requires POST with _method=PUT for multi-part update requests
