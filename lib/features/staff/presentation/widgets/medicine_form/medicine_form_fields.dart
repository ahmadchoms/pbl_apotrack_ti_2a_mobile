        ...
        children: [
          ...
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: _focused ? AppColors.primaryLight.withValues(alpha: 0.5) : AppColors.background,
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: _focused ? AppColors.primary.withValues(alpha: 0.5) : Colors.transparent,
                width: 1.5,
              ),
            ),
            child: TextField(
    ...
    return Padding(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: value ? activeColor.withValues(alpha: 0.25) : Colors.transparent,
            width: 1.5,
          ),
        ),
        child: Row(
          children: [
            Container(
              ...
              height: 36,
              decoration: BoxDecoration(
                color: value ? activeColor.withValues(alpha: 0.15) : AppColors.surface,
